        ...
        <div className='w-full bg-white py-16 px-4'>
            <div className= 'max-w-[1240px] mx-auto grid md:grid-cols-2'>
                ...
                <div className='flex flex-col justify-center'>
                    <p className='text-blue-500 font-bold'>DATA ANALYSTICS DASHBOARD</p>
                    ...
                    <button className='bg-blue-500 text-white w-[200px] rounded-md font-medium my-6 mx-auto md:mx-2 py-3'>See Gallery</button>
                </div>
            </div>
